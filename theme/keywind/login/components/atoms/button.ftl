<#macro kw color="" component="button" size="" rest...>
  <#switch color>
    <#case "primary">
      <#assign colorClass="bg-pier-button text-white focus:bg-pier-button hover:bg-pier-button font-bold">
      <#break>
    <#case "secondary">
  ...
  <#switch size>
    ...
    <#case "small">
      ...
      <#break>
    <#default>
      <#assign sizeClass="px-4 py-3 text-xs">
  </#switch>

  <${component}
    class="${colorClass} ${sizeClass} flex justify-center relative rounded-lg w-full focus:outline-none focus:ring-2 focus:ring-offset-2 uppercase"
